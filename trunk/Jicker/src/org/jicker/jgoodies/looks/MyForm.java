...
public class MyForm extends JPanel
{
   ...
   public JPanel createPanel()
   {
      ...
      FormLayout formlayout1 = new FormLayout("FILL:144PX:NONE,FILL:DEFAULT:GROW(1.0)","FILL:465PX:GROW(1.0)");
      CellConstraints cc = new CellConstraints();
      jpanel1.setLayout(formlayout1);

      jpanel1.add(createphotoPanel(),new CellConstraints(2,1,1,1,CellConstraints.FILL,CellConstraints.FILL));
   ...
   public JPanel createphotoPanel()
   {
      ...
      FormLayout formlayout1 = new FormLayout("FILL:DEFAULT:NONE,FILL:DEFAULT:NONE,FILL:DEFAULT:NONE,FILL:DEFAULT:NONE,FILL:DEFAULT:NONE,FILL:DEFAULT:NONE,FILL:DEFAULT:NONE,FILL:DEFAULT:NONE,FILL:DEFAULT:NONE,FILL:DEFAULT:NONE","TOP:DEFAULT:NONE,CENTER:DEFAULT:NONE,CENTER:DEFAULT:NONE,CENTER:DEFAULT:NONE,CENTER:DEFAULT:NONE,CENTER:DEFAULT:NONE,CENTER:DEFAULT:NONE,CENTER:DEFAULT:NONE,CENTER:DEFAULT:NONE,CENTER:DEFAULT:NONE");
      CellConstraints cc = new CellConstraints();
      ...
      addFillComponents(m_photoPanel,new int[]{ 3,4,5,6,7,8,9,10 },new int[]{ 2,3,4,5,6,7,8,9,10 });
      return m_photoPanel;
   }
