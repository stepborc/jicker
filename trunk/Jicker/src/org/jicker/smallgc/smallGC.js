...
var code = grab($("id('ctl00_ContentBody_uxWaypointName')"));
GM_log("code:"+code);
...
var noattr=$$("//div[@class='CacheDetailNavigationWidget BottomSpacing']/div[@class='WidgetBody']/img[@title='blank']");
...
var attr = $$("//div[@class='CacheDetailNavigationWidget BottomSpacing']/div[@class='WidgetBody']");
