...
public class CatBreedPanel extends javax.swing.JPanel {
	...
	/** The Constant SHORT_HAIR_BREEDS. */
	private static final String[] SHORT_HAIR_BREEDS = new String[] { "Siamese",
			"Manx", "Burmese" };

	/** The Constant LONG_HAIR_BREEDS. */
	private static final String[] LONG_HAIR_BREEDS = new String[] { "Persian",
			"Himalayan" };

	/** The Constant KEY_CAT_BREED. */
	public static final String KEY_CAT_BREED = "catBreed";

	/** The Constant KEY_PET_NAME. */
	...
	private void configureComboContents() {
		boolean shorthair = CatHairLengthPanel.VALUE_SHORT.equals(wizardData
				.get(CatHairLengthPanel.KEY_HAIR));

		String[] comboData = shorthair ? SHORT_HAIR_BREEDS : LONG_HAIR_BREEDS;
	...
	/**
	 * J text field1 caret update.
	 *
	 * @param evt
	 *            the evt
	 */
	private void jTextField1CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-
																			// FIRST
																			// :
																			// event_jTextField1CaretUpdate
